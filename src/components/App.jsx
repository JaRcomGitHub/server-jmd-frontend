...
const PPKListPage = lazy(() => import('../pages/PPKListPage'));
const PPKpage = lazy(() => import('../pages/PPKpage'));
      ...
      <Layout>
        <Routes>
          <Route path="/" element={<SharedLayout />}>
            ...
            <Route path="ppk" element={<PPKListPage />} />
            <Route path="ppk/:ppkid" element={<PPKpage />} />
